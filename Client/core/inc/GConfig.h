...
class GConfig
{
	private:
		...
		void	get_TWITCH_Flag(std::string& Key);
		void	get_NETFLIX_Flag(std::string& Key);
		void	get_SUBSPACE_Flag(std::string& Key);
		void	get_TENCENT_Flag(std::string& Key);
		...
		void	get_TWITCH(std::string& Key);
		void	get_NETFLIX(std::string& Key);
		void	get_SUBSPACE(std::string& Key);
		void	get_TENCENT(std::string& Key);
